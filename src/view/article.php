    ...
    <section class="section dashboard" id="article">
        <div class="search-bar-custom">
            <form class="search-form-custom d-flex align-items-center" method="POST" action="#">
                <input type="text" name="search-input" id="search-input" placeholder="Search" title="Enter search keyword">
                <button type="submit" name="search" id="search" title="Search"><i class="bi bi-search"></i></button>
            </form>
        </div>
        <div class="row">
            ...
            foreach ($data as $row) {
                ...
                <div class="card col-lg-3 col-md-6 col-sm-12" style="padding: 0px; margin-right: 20px; margin-left: 10px">
                    <img src="assetsWeb/img/education/<?=  $row['img']; ?>" class="card-img-top" alt="..." style="padding: 0 0 0 0" >
                    <div class="card-body">
